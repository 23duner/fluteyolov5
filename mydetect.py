...
weights = 'F:\cccc/flutestudy\yolo\yolov5/best.pt'  # 训练好的模型位置
opt_device = '0,1'  # device = 'cpu' or '0' or '0,1,2,3'
imgsz = 640
opt_conf_thres = 0.25
opt_iou_thres = 0.5
...
def predict_(pic_):
    ...
    with open('F:\cccc/flutestudy\yolo\yolov5/runs\detect/exp1.json', 'w') as f:
